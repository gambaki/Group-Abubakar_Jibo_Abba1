...
/**
	 * 
	 */
	private static final long serialVersionUID = -3550492439500805171L;
		...
		if(source==btnLogin){
			try{
				...
				if((str1.length()==0 || str2.length()==0)){
    					JOptionPane.showMessageDialog(null,"empty Field Connot be Process","WARNING",JOptionPane.WARNING_MESSAGE);
    				}
    				else{
